...
- **Netflix Conductor OSS Java SDK**: Кастомный набор классов и аннотаций для создания и упровления рабочего процесса.
...
```
4. Запуск saga воруфлоу с эмитации ошибки на степе inventory
```bash
curl --location 'http://localhost:8090/api/orders/start-saga' \
--header 'Content-Type: application/json' \
--data '{
