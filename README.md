...
Приложение для демонстрации паттерна **Saga** (оркестровая модель) с использованием **Netflix Conductor OSS**, **Java 21** и **Spring Boot 3.4+**.

[![Java](img.shields.io)](www.oracle.com)
[![Spring Boot](img.shields.io)](spring.io)
[![Conductor](img.shields.io)](conductor-oss.org)
